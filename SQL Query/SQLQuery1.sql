...
exec [GenerateTimeTablesForAllSession] @StartDate = '01/01/2023', @EndDate = '01/01/2023', @Message = @Message

select * from TimeTblTable
select * from TimeTableDetailsTable

alter PROC [dbo].[GenerateTimeTablesForAllSession] (@StartDate Date, @EndDate Date, @Message nvarchar(100) output)
AS 
BEGIN
...
DECLARE @ALLSubjectSemesterTable Table(RowNo int, RepeatedRowNo int,ProgramSemesterID int,CreditHours int, ProgramSemesterSubjectID int,SemesterSubjectTitle nvarchar(300),Title nvarchar(200),RoomTypeID int,LectureID int,SessionID int, SessionTitle NVARCHAR(200))
DECLARE @SubjectSemesterTable Table(RowNo int,ProgramSemesterID int,CreditHours int, ProgramSemesterSubjectID int,SemesterSubjectTitle nvarchar(300),Title nvarchar(200),RoomTypeID int,LectureID int,SessionID int, SessionTitle NVARCHAR(200))

-- Get All Practical Class
DECLARE @PracticalSubjectTable Table(ProgramSemesterID int,CreditHours int, ProgramSemesterSubjectID int,SemesterSubjectTitle nvarchar(300),Title nvarchar(200),RoomTypeID int,LectureID int,SessionID int, SessionTitle NVARCHAR(200))
DECLARE @PracticalRandomSubjectTable Table(RowNo int,ProgramSemesterID int,CreditHours int, ProgramSemesterSubjectID int,SemesterSubjectTitle nvarchar(300),Title nvarchar(200),RoomTypeID int,LectureID int,SessionID int, SessionTitle NVARCHAR(200))

-- Get All Non Practical Class
DECLARE @NonPracticalSubjectTable Table(ProgramSemesterID int,CreditHours int, ProgramSemesterSubjectID int,SemesterSubjectTitle nvarchar(300),Title nvarchar(200),RoomTypeID int,LectureID int,SessionID int, SessionTitle NVARCHAR(200))
DECLARE @NonPracticalRandomSubjectTable Table(RowNo int,ProgramSemesterID int,CreditHours int, ProgramSemesterSubjectID int,SemesterSubjectTitle nvarchar(300),Title nvarchar(200),RoomTypeID int,LectureID int,SessionID int, SessionTitle NVARCHAR(200))
...
Insert into @SubjectSemesterTable(RowNo,ProgramSemesterID,CreditHours,ProgramSemesterSubjectID,SemesterSubjectTitle,Title,RoomTypeID,LectureID,SessionID,SessionTitle) select Row_Number() over(Order By(SELECT 1)) as RowNo, ProgramSemesterID,CreditHours,ProgramSemesterSubjectID,SemesterSubjectTitle,Title,RoomTypeID,LectureID,SessionID,SessionTitle From v_AllSemesterSectionSubjects Order By NewID();
...
DECLARE @CountRecord int = (Select Count(*) From @SubjectSemesterTable);
        ...
        BEGIN
            DECLARE @RepeatPrint AS INT = (SELECT CreditHours From @SubjectSemesterTable where RowNo = @IndexNo);
                    DECLARE @CountCrHrs int = 1;
                          WHILE @CountCrHrs <=@RepeatPrint
                          BEGIN
                            Insert into @ALLSubjectSemesterTable(RowNo,RepeatedRowNo,ProgramSemesterID,CreditHours,ProgramSemesterSubjectID,SemesterSubjectTitle,Title,RoomTypeID,LectureID,SessionID,SessionTitle) select @RowNo, RowNo, ProgramSemesterID,CreditHours,ProgramSemesterSubjectID,SemesterSubjectTitle,Title,RoomTypeID,LectureID,SessionID,SessionTitle From @SubjectSemesterTable WHERE RowNo = @IndexNo;
...
INSERT INTO @PracticalSubjectTable(ProgramSemesterID,CreditHours,ProgramSemesterSubjectID,SemesterSubjectTitle,Title,RoomTypeID,LectureID,SessionID,SessionTitle) 

SELECT ProgramSemesterID,CreditHours,ProgramSemesterSubjectID,SemesterSubjectTitle,Title,RoomTypeID,LectureID,SessionID,SessionTitle From @ALLSubjectSemesterTable WHERE RoomTypeID = 4  Order By NewID();

INSERT INTO @PracticalRandomSubjectTable(RowNo,ProgramSemesterID,CreditHours,ProgramSemesterSubjectID,SemesterSubjectTitle,Title,RoomTypeID,LectureID,SessionID,SessionTitle) 

SELECT ROW_NUMBER() over (Order By (Select 1)), ProgramSemesterID,CreditHours,ProgramSemesterSubjectID,SemesterSubjectTitle,Title,RoomTypeID,LectureID,SessionID,SessionTitle From @PracticalSubjectTable;



-- Getting Non Practical Class

INSERT INTO @NonPracticalSubjectTable(ProgramSemesterID,CreditHours,ProgramSemesterSubjectID,SemesterSubjectTitle,Title,RoomTypeID,LectureID,SessionID,SessionTitle) 

SELECT ProgramSemesterID,CreditHours,ProgramSemesterSubjectID,SemesterSubjectTitle,Title,RoomTypeID,LectureID,SessionID,SessionTitle From @ALLSubjectSemesterTable WHERE RoomTypeID = 3  Order By NewID();

INSERT INTO @NonPracticalRandomSubjectTable(RowNo,ProgramSemesterID,CreditHours,ProgramSemesterSubjectID,SemesterSubjectTitle,Title,RoomTypeID,LectureID,SessionID,SessionTitle) 

SELECT ROW_NUMBER() over (Order By (Select 1)), ProgramSemesterID,CreditHours,ProgramSemesterSubjectID,SemesterSubjectTitle,Title,RoomTypeID,LectureID,SessionID,SessionTitle From @NonPracticalSubjectTable;
...
CROSS JOIN (SELECT * FROM RoomTable where IsActive = 1) RT WHERE SlotStatus = 1 ORDER BY RT.RoomID
...
CROSS JOIN (SELECT * FROM LabTable where IsActive = 1) LT WHERE SlotStatus = 1 ORDER BY LT.LabID
...
DECLARE @OneByOneSemester int = 1;
	...
	-- SELECTION/CROSSOVER OPERATOR
		...
		BEGIN
			...
			DECLARE @LabSubjectTitle nvarchar(300)=  (SELECT TOP 1 Title + ' ' + SemesterSubjectTitle FROM @PracticalRandomSubjectTable WHERE RowNo = @OneByOnePracticalSubject);
		...
		DECLARE @OneByOneNonPracticalSubject int  = 1;		-- SELECTION/CROSSOVER OPERATOR
		...
		BEGIN
			...
			DECLARE @RoomSubjectTitle nvarchar(300)=  (SELECT TOP 1 Title + ' ' + SemesterSubjectTitle FROM @NonPracticalRandomSubjectTable WHERE RowNo = @OneByOneNonPracticalSubject);
